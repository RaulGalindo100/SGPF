...
public class GeneraReporte extends HttpServlet {
    ...
    private void generatePDF(Proyecto proy, List<ProcesoFuncional> listaPF) throws Exception {
        try {
            ...
            document.add(new Paragraph("        NÃºmero Total de Procesos Funcionales: " + listaPF.size(), fontNormal2));
            document.add(new Paragraph("        PropÃ³sito del Proyecto: " + proy.getProposito(), fontNormal2));
            ...
            document.add(new Paragraph("    2.  RESUMEN DE MEDICIÃ“N", fontNormal2));

            //# Procesos Funcionales
            document.add(new Paragraph("        Procesos Funcionales", fontNormal2));
            int pfCont = 1;
            for (ProcesoFuncional pf : listaPF) {
                document.add(new Paragraph("        " + pfCont + ") " + pf.getNomPF() + ". DescripciÃ³n: " + pf.getDescripcion(), fontNormal2));
                pfCont++;
            }
